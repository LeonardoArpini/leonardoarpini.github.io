...
if (timelineStyleBtns.length > 0 && timeline) {
  timelineStyleBtns.forEach(btn => {
    btn.addEventListener('click', function () {
      // Remove active class from all buttons
      timelineStyleBtns.forEach(b => b.classList.remove('active'));
      ...
      // Update timeline data-style attribute
      timeline.dataset.style = selectedStyle;
      ...
      // Log style change
      console.log(`%c🔄 Timeline style changed to: ${selectedStyle}`, 'color: #00ff88; font-weight: bold;');
    });
  });
}
