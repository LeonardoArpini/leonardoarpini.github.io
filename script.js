...
const translations = {
  ...
  'pt': {
    ...
    'about-text-1': 'Doutor em Química pelo <span class="accent-text">Instituto de Química da USP</span> de São Paulo, Brasil, com especialização em nanomateriais e catálise. Atualmente atuo como pesquisador Postdoctoral na <span class="accent-text">University of Southern California (USC)</span> em Los Angeles, CA, USA.',
    ...
    'about-text-3': 'Com formação acadêmica sólida incluindo Mestrado em Química Orgânica pela UFES e Bacharelado em Química, desenvolvi expertise em catálise heterogênea, química de superfície e processos de conversão energética.',
    ...
    'res-co2-desc': 'Hidrogenação de CO₂ para produção de metanol, CO e hidrocarbonetos usando catalisadores de níquel, cobre e nanopartículas plasmônicas',
    ...
    'exp-usc-desc': 'Preparação, caracterização e aplicação de catalisadores de Cu para síntese de Metanol a partir da hidrogenação do CO₂ em alta pressão. Desenvolvimento de nanopartículas plasmônicas de TiN para captura de CO₂.',
    'exp-ucr-title': 'Pesquisador de Pós-Doutorado',
    'exp-ucr-desc': 'Síntese e caracterização de catalisadores óxidos para conversão de simulantes químicos. Desenvolvimento de catalisadores de Ni para conversão de CH₄ e CO₂.',
    ...
    'exp-usp-desc': 'Tese: "Design de nanocatalisadores híbridos de níquel e carbono e suas aplicações em reações de hidrogenação". Orientadora: Prof. Liane Marcia Rossi. Bolsista FAPESP.',
    ...
    'exp-ufes-grad-title': 'Graduação em Química',
    ...
    'skill-tech-4': 'Espectroscopia IR/Raman',
    ...
    'skill-analytic': 'Competências Analíticas',
    'skill-analytic-1': 'Design de Experimentos',
